...
def run_agent(pod_name, namespace):
    ...
    #     '{"owner":"gizzi-rhs","repo":"etx-agentic-ai",'
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'gizzi-rhs', repo 'etx-agentic-ai', "
